...
//adaptação entre dataclass e o item_list layout resurce
class ContactListAdapter :
    ...
    // viewholder = view que segura os dados e vai retornar os dados ao usuario (qual nome, qual telefone, img)
    class ContactViewHolder(private val view: View ) : RecyclerView.ViewHolder(view) {
        ...
        //puxar fotos / contatos / numeros da lista
    ...
    //recycler view e uma lista que faz reciclagem para garantir que nao esta consumido memoria (
    // compara a diferença quando nossa lista e atualizada ( se tirou... atualiza retirando.. e colocou atualiza colocando)
